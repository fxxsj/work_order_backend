...
from ...models import ProductStock, QualityInspection, StockIn, StockOut
from ..utils import STOCK_STATUS_COLORS, create_status_badge_method
...
class QualityInspectionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            "基本信息",
            {"fields": ("inspection_number", "product", "inspection_type", "status")},
        ),
        ("批次信息", {"fields": ("batch_number", "quantity")}),
        ("检验信息", {"fields": ("inspection_date", "inspector", "result")}),
        (
            "缺陷统计",
            {"fields": ("defective_quantity", "defective_rate", "defect_types")},
        ),
