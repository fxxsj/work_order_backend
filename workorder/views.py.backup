...
from .permissions import WorkOrderProcessPermission, WorkOrderMaterialPermission, WorkOrderTaskPermission, WorkOrderDataPermission
...
from .serializers import (
    ...
    SupplierSerializer, MaterialSupplierSerializer, PurchaseOrderListSerializer,
    PurchaseOrderDetailSerializer, PurchaseOrderItemSerializer,
    SalesOrderListSerializer, SalesOrderDetailSerializer, SalesOrderItemSerializer
)
...
class WorkOrderTaskViewSet(viewsets.ModelViewSet):
    ...
    def batch_assign(self, request):
        ...
        - notes: 备注（可选）
        """
        from .models import TaskLog, Department
        from django.contrib.auth.models import User
