...
用法::
    ...
    raise ServiceError("库存不足", code=status.HTTP_422_UNPROCESSABLE_ENTITY, data={"current": 10, "required": 20})
...
class ServiceError(Exception):
    def __init__(self, message: str, code: int | str = status.HTTP_400_BAD_REQUEST, data: Optional[Dict[str, Any]] = None):
