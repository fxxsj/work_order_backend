...
class WorkOrderFlowPolicy:
    ...
    @staticmethod
    def require_permission(user: User, permission: str, message: str = "权限不足") -> None:
    ...
    @staticmethod
    def ensure_work_order_writable(*, work_order: WorkOrder, user: User) -> None:
    ...
    @staticmethod
    def validate_approval_permissions(*, work_order: WorkOrder, user: User) -> None:
